 ...
 */
  ...
  */
  ...
  @BasicAuth()
  async getOwnAcccount(@User() id: string, @Platform() platform: string, @ManagedCommunity() community: string): Promise<AccountResponseDto> {
    return await this.accountService.getOwnAccount(id, platform, community)
  }
